...
with col2:
    ...
    practising Python from Udemy for quite a while now. I like coding but the most fun part is when an issue comes
    with my code, I like investigating and solving the error on my own.
